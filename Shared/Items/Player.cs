...
namespace Fanior.Shared
{
    public class Player : Character
    {
        ...
        public Player() { }
        public Player(string name, string connectionId, Gvars gvars, double x, double y, Shape shape, Mask mask, IMovement defaultMovement, double movementSpeed, double acceleration, double friction, double lives, double regeneration, WeaponNode weapon, double shield, bool isVisible = true)
        ...
        public Player(string name, string connectionId, Gvars gvars, double x, double y, Shape shape, IMovement defaultMovement, double movementSpeed, double acceleration, double friction, double lives, double regeneration, WeaponNode weapon, double shield, bool isVisible = true)
